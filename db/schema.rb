...
ActiveRecord::Schema.define(version: 20170803194136) do
  ...
  create_table "users_lessons", force: :cascade do |t|
    ...
    t.integer  "user_id"
    t.integer  "lesson_id"
    t.index ["lesson_id"], name: "index_users_lessons_on_lesson_id", using: :btree
    t.index ["user_id"], name: "index_users_lessons_on_user_id", using: :btree
  end
